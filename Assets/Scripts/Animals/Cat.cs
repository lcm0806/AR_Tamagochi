...
public class Cat : MonoBehaviour , IDamagotchi
{
    ...
    public bool IsHappyMaxed => _happiness >= 80;
    ...
    public void Feed(int amount)
    {
        ...
        Debug.Log($"고양이에게 {amount}만큼 먹이를 줬습니다. 현재 배고픔: {_hunger}");
    }
    ...
    public void Play(int duration)
    {
        ...
        Debug.Log($"고양이와 {duration}분 놀았습니다. 현재 행복: {_happiness}");
    }
    ...
    public void Sleep(int duration)
    {
        ...
        Debug.Log($"고양이가 {duration}분 잠들었습니다. 현재 체력: {_health}");
    }
    ...
    public void UpdateStatus()
    {
        ...
        Debug.Log($"고양이 상태 업데이트: 체력={_health}, 배고픔={_hunger}, 행복={_happiness}");
    }
